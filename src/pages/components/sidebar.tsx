...
const Sidebar: React.FC = () => {
  ...
  useEffect(() => {
    const handleResize = () => {
      if (window.innerWidth >= 768) {
        setLeftMenuState(true); // Open sidebar on desktop
      } else {
        setLeftMenuState(false); // Close sidebar on small devices
      }
    };
    ...
    return (
      ...
      >
        <path
          ...
          strokeWidth="2"
          d={isOpen ? "M1 5l4-4 4 4" : "M1 1l4 4 4-4"}
        />
      </svg>
    );
  };
  ...
  return (
    <>
      <nav className="fixed shadow-md  top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start rtl:justify-end">
              <button
                ...
                type="button"
                aria-expanded={leftMenuState ? "true" : "false"}
                onClick={() => setLeftMenuState(!leftMenuState)}
              ...
              <div className="flex items-center ms-3">
                <div>
                  <button
                    ...
                    aria-expanded={userDropdownState ? "true" : "false"}
                    onClick={() => setUserDropdownState(!userDropdownState)}
                  >
                    <span className="sr-only">Open user menu</span>
                    <img
                      className="w-8 h-8 rounded-full"
                      src="/__temp/profile-picture-1.png"
                      alt="user photo"
                    />
                  </button>
                  {userDropdownState && (
                    <div
                      className="z-50   absolute right-0  my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                      id="dropdown-user"
                    >
        ...
        <div className="hidden absolute bottom-0 left-0 justify-center p-4 space-x-4 w-full lg:flex bg-white dark:bg-gray-800 z-20 border-r border-gray-200 dark:border-gray-700">
          ...
          <div>
            <button
              ...
              onClick={() => toggleDropdown("languageDrp")}
            ...
            {openSubMenus.languageDrp && (
              <div
                className="z-50 bottom-full  absolute  my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700"
